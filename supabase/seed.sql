-- Run this after schema.sql to migrate the existing hardcoded projects
...
insert into public.experience
  (company, role, type, start_date, end_date, description, bullets, skills, display_order)
values
(
  'Ushur',
...
(
  ...
  array['Strategy', 'Market Research', 'Client Management', 'Consulting', 'Presentation'],
  2
),
(
  'Alpha Kappa Psi',
  ...
  null,
  array[]::text[],
  array['Leadership', 'Public Speaking', 'Budget Management', 'Event Planning', 'Conflict Resolution'],
  3
),
(
  'Formula Slug',
  'High Voltage Electrical Team Member',
  'technical',
  '2025-10',
  null,
  ...
  array['PCB Design', 'High Voltage', 'Battery Systems', 'Altium', 'Electrical Schematics'],
  4
)
...
values
  ('JavaScript',  'programming', '/skills/javascript.svg', 4, 1),
  ('Python',      'programming', '/skills/python.png',     5, 2),
  ('C',           'programming', '/skills/C.png',          4, 3),
  ('MATLAB',      'programming', '/skills/matlab.svg',     3, 4),
  ('React',       'frontend',    '/skills/react.svg',      4, 5),
  ('TailwindCSS', 'frontend',    '/skills/tailwindcss.svg',4, 6),
  ('CSS',         'frontend',    '/skills/css.svg',        4, 7),
  ('Node.js',     'backend',     '/skills/nodejs.svg',     3, 8),
  ('Onshape',     'cad',         '/skills/onshape.png',    3, 9),
  ('Fusion 360',  'cad',         '/skills/fusion360.svg',  5, 10)
